...
2. Каждый найденный транскрипт с участием Германа должен быть учтен в профиле
...
5. В конце работы предоставь сводку: сколько файлов проверено, в скольких найден Герман

Твоя задача:
1. Изучи транскрипты из директории /transcripts/
2. Создай цифровой профиль сотрудника Герман в директории /memories/
...
Если профиль уже существует в памяти, обнови его на основе нового контекста, сохранив всё предыдущее содержимое и явно отметив изменения.
...
1. Предварительное изучение транскрипта
...
2. Точная идентификация высказываний участника
